...
- **Filename**: water-ambient.ogg
- **Title**: Water on Rocks
- **Author**: Dsw4
- **License**: Creative Commons Attribution 3.0 Unported (CC BY 3.0)
- **Source**: https://commons.wikimedia.org/wiki/File:Water_on_Rocks.ogg
- **Description**: Field recording of waves breaking on rocks, shores of Lake Ontario, Webster NY (2008).

## Gramophone repertoire (留声机曲库)

All four tracks are bundled offline in `public/audio/` and played, spatialised at the gramophone, as
a continuous program (each finishes, the next begins). Composers are long in the public domain;
the recordings below are each PD or CC0.

### music-nocturne.mp3

- **Title**: Nocturne in E-flat major, Op. 9 No. 2
- **Composer**: Frédéric Chopin (1810–1849, public domain)
- **Performer**: Frank Levy (recording released to public domain via Musopen)
- **License**: Public Domain (CC0-equivalent; released via Musopen)
- **Source**: https://commons.wikimedia.org/wiki/File:Nocturne_in_E_flat_major,_Op._9_no._2.mp3

### music-nocturne-op9no1.ogg

- **Title**: Nocturne No. 1 in B-flat minor, Op. 9 No. 1
- **Composer**: Frédéric Chopin (public domain)
- **Performer**: Vadim Chaimovich
- **License**: CC0 1.0 (Public Domain Dedication)
- **Source**: https://commons.wikimedia.org/wiki/File:Chopin,_Nocturne_No._1_in_B_Flat_Minor,_Op._9.ogg

### music-nocturne-cminor.ogg

- **Title**: Nocturne in C-sharp minor, Op. posth.
- **Composer**: Frédéric Chopin (public domain)
- **Performer**: Aaron Dunn
- **License**: CC0 1.0 (Public Domain Dedication)
- **Source**: https://commons.wikimedia.org/wiki/File:Chopin,_Nocturne_in_C-sharp_minor,_Op._Posth.ogg

### music-gymnopedie1.ogg

- **Title**: Gymnopédie No. 1
- **Composer**: Erik Satie (1866–1925, public domain)
